    ...
    public void solveIDAstar() { //giải quyết IDA*
        ...
        while (true) {
            while (FRINGE.size() != 0) //quá trình tìm kiếm sâu dần
            {
                ...
                if (n.f <= cutOff) {
                    count++; //nếu nút n có f ko vượt ngưỡng cutOff thì n là nút đã được xét
                }
                ...
                if (n.f <= cutOff) //nếu nút n có f ko vượt ngưỡng cutOff thì xét n
                {
                    ...
                    VISIT.add(0, n); // nếu n.f vượt ngưỡng cutOff thì thêm n vào VISIT
                }
            }//end while
            ...
            for (int i = 0; i < VISIT.size(); i++) {
                ...
                if (number < fmin) {
                    fmin = number; //tìm nút có f nhỏ nhất trong VISIT
                }
            }
